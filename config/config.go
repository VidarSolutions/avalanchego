...
import (
	...
	"github.com/VidarSolutions/avalanchego/nat"
	...
	"github.com/VidarSolutions/avalanchego/node"
	...
	"github.com/VidarSolutions/avalanchego/utils/dynamicip"
	"github.com/VidarSolutions/avalanchego/utils/ips"
	"github.com/VidarSolutions/avalanchego/utils/logging"
	"github.com/VidarSolutions/avalanchego/utils/password"
	...
	"github.com/VidarSolutions/avalanchego/utils/storage"
...
func GetNodeConfig(v *viper.Viper) (node.Config, error) {
	...
	nodeConfig.GenesisBytes, nodeConfig.VidarAssetID, err = getGenesisData(v, nodeConfig.NetworkID, &genesisStakingCfg)
	if err != nil {
